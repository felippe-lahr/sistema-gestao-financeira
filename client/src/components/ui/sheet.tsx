    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        onPointerDownOutside={(e) => {
          // Sempre prevenir fechamento por clique fora — o usuário fecha pelo botão X ou Cancelar
          e.preventDefault();
        }}
        onInteractOutside={(e) => {
          // Sempre prevenir fechamento por interação fora — o usuário fecha pelo botão X ou Cancelar
          e.preventDefault();
        }}
        className={cn(
