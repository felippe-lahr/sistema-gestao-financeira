...
interface RentalAttachmentUploaderProps {
  rentalId?: number;
  ...
  onPreview: (attachment: RentalAttachment) => void;
}
...
export function RentalAttachmentUploader({
  rentalId,
  attachments,
  onUpload,
  onDelete,
