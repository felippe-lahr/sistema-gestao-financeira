      ...
      <div className="flex min-h-screen">
        ...
        <div className="flex-1 flex items-center justify-center p-6 sm:p-10 bg-white dark:bg-gray-950 min-h-screen">
          <div className="w-full max-w-md text-center space-y-6">
            <div className="flex justify-center lg:hidden mb-6">
              <img src="/logo-unifique-pro.png" alt="UnifiquePro" style={{ width: '200px' }} className="h-auto object-contain dark:hidden" />
            ...
            <div className="rounded-xl bg-gray-50 dark:bg-gray-900 border border-gray-100 dark:border-gray-800 p-4 text-left space-y-2">
              ...
              <ol className="space-y-1.5 text-sm text-gray-500 dark:text-gray-400 list-decimal list-inside">
            ...
            <div className="space-y-2">
              <p className="text-xs text-gray-400">Não recebeu o e-mail?</p>
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 flex-col items-center justify-center p-12">
          <div className="absolute inset-0 opacity-10">
            <div className="absolute top-0 left-0 w-96 h-96 bg-white preserve-white rounded-full -translate-x-1/2 -translate-y-1/2" />
            <div className="absolute bottom-0 right-0 w-80 h-80 bg-white preserve-white rounded-full translate-x-1/3 translate-y-1/3" />
            <div className="absolute top-1/2 left-1/2 w-64 h-64 bg-white preserve-white rounded-full -translate-x-1/2 -translate-y-1/2" />
          </div>
    ...
    <div className="flex min-h-screen">
      ...
      <div className="flex-1 flex items-center justify-center p-6 sm:p-10 bg-white dark:bg-gray-950 min-h-screen">
        <div className="w-full max-w-md">
          ...
          {/* Título */}
          <div className="mb-6">
            <h1 className="text-2xl font-bold text-gray-900 dark:text-white">{stepTitles[step - 1].title}</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400 mt-1">{stepTitles[step - 1].description}</p>
          </div>
            ...
            <>
              ...
              <div className="relative mb-5">
                ...
                <div className="relative flex justify-center text-xs uppercase">
                  <span className="bg-white dark:bg-gray-950 px-3 text-gray-400">ou cadastre com e-mail</span>
                </div>
              </div>
            </>
          )}
