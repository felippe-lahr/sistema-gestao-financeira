      ...
      <div className="flex min-h-screen">
        ...
        <div className="hidden lg:flex lg:w-1/2 xl:w-3/5 relative overflow-hidden bg-gradient-to-br from-blue-600 via-blue-700 to-indigo-800 flex-col items-center justify-center p-12">
          ...
          <div className="relative z-10 text-center text-white max-w-md">
            ...
            <h2 className="text-3xl font-bold mb-4 leading-tight">Gerencie suas finanças com inteligência</h2>
            <p className="text-blue-100 text-lg leading-relaxed mb-8">Controle transações, investimentos e patrimônio de múltiplas entidades em um único lugar.</p>
